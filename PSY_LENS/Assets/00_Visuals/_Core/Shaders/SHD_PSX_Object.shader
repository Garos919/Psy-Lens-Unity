    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            struct v2f
            {
                ...
                SHADOW_COORDS(3)
                float4 worldTangent : TEXCOORD4; // xyz = tangent, w = sign
                UNITY_FOG_COORDS(5)
            };
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                // Dither AFTER alpha read, BEFORE clip
        ...
        // ---------- ADD PASS (extra point / spot lights) ----------
        Pass
        {
